    ...
    <article className="flex flex-col gap-5">
      ...
      <Section title="Données que nous traitons">
        <ul className="list-disc ps-5 flex flex-col gap-1.5">
          ...
          <li><b>Commande en groupe (facultatif).</b> Le pseudonyme que vous choisissez pour rejoindre une table partagée est visible par les autres participants et conservé le temps de la session.</li>
