      ...
      <div className="w-full max-w-[400px] bg-card border border-line rounded-2xl shadow-[0_2px_10px_rgba(60,35,15,0.05)] p-8 flex flex-col gap-6">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col items-center gap-1 text-center">
            <h1 className="font-display font-extrabold text-xl text-ink">{t.auth.signInTitle}</h1>
            <p className="text-[13px] text-muted">{t.auth.signInSubtitle}</p>
          </div>
        </div>

        <GoogleSignIn ctx="business" />
