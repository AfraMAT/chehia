...
export default function MenuPage() {
  ...
  const { restaurant, table, categories, items, cart, groupsByItem } = venue;
  ...
  return (
    <div className="flex flex-col min-h-dvh pb-24">
      ...
      <header className="px-5 pt-4 flex items-center gap-2.5">
        ...
        <Link
          href={`/r/${restaurant.slug}/t/${table.qr_token}`}
      ...
      {count > 0 && (
        <button
          type="button"
          onClick={() => router.push(`/r/${restaurant.slug}/t/${table.qr_token}/cart`)}
